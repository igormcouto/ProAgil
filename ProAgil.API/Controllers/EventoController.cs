...
namespace ProAgil.API.Controllers
{
    ...
    public class EventoController : ControllerBase
    {
        ...
        public async Task<IActionResult> upload()
        {
            ...
            {
                return this.StatusCode(StatusCodes.Status500InternalServerError, $"Erro ao realizar upload! {ex.Message}");
            }
        }
        ...
        public async Task<IActionResult> Get(int EventoId)
        {
            try
            {
            var evento = await _repo.GetEventoAsyncId(EventoId,true);
        ...
        public async Task<IActionResult> Put(int EventoId, EventoDto model)
        {
            try
            {
                var evento = await _repo.GetEventoAsyncId(EventoId,false);

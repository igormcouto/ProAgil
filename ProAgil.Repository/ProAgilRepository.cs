...
namespace ProAgil.Repository
{
    public class ProAgilRepository : IProAgilRepository
    {
        ...
        public async Task<Evento[]> GetEventoAsyncByTema(string tema, bool includePalestrante = false)
        {
            IQueryable<Evento> query = _context.Eventos
                            .Include(c => c.Lotes)
                            .Include(c => c.RedesSociais);
        ...
        public async Task<Evento> GetEventoAsyncId(int EventoId, bool includePalestrante = false)
        {
            IQueryable<Evento> query = _context.Eventos
                            .Include(c => c.Lotes)
                            .Include(c => c.RedesSociais);
